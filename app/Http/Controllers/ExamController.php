    ...
    public function loadExamDashboard($id){
        ...
        if(count($qnaExam) > 0){
            ...
            if($attemptCount >= $qnaExam[0]['attempt']){
                return view('student.exam-dashboard',['success'=>false,'msg'=>'Your exam attemtion hash been completed. :)','exam'=>$qnaExam]);
            }
                ...
                if(count($qnaExam[0]['getQnaExam']) > 0){
                    ...
                    return view('student.exam-dashboard',['success'=>false,'msg'=>'This exam will not available for now!','exam'=>$qnaExam]);
                }
            }else if($qnaExam[0]['date'] > date('Y-m-d')){
