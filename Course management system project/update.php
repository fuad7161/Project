  ...
  if (empty($fname_err) && empty($lname_err) && empty($email_err) && empty($course_err) && empty($batch_err) && empty($city_err) && empty($state_err)) {
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
      ...
      if (mysqli_stmt_execute($stmt)) {
        ...
        echo "<script>window.location.href='http://localhost/php_crud/student.php';</script>";
        exit;
      } else {
  ...
  <div class="container">
    <div class="row justify-content-center pt-5">
      <div class="col-lg-6">
        ...
        <h4 align="center">Update Student Info
        <p class="text-end">
      <a href="student.php" class="btn btn-secondary">&laquo; Go back</a>
    </p>
      </h4></div>
          <div class="row">
