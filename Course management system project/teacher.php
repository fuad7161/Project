...
<body style="background-color:#E0FFFF;">
    <div class="container">
            <div>
            <h1 class="text-center">Teachers Table</h1>
            </div>
    <div>
        <a href="create_teacher.php" class="btn btn-secondary my-4">
        ...
        <table style="background-color:#F0FFFF" class="table table-bordered table-striped align-middle">
            ...
            <tbody>
                ...
                if(isset($_POST['submit'])){
                  ...
                  or city = '$search' or state = '$search'";
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            foreach ($rows as $row) { ?>
                <tr>
                    ...
                    <td><?= ucwords($row["state"]); ?></td>
                    <td>
                        <a href="read_teachar.php?id=<?= $row["id"]; ?>" class="btn btn-info btn-sm">
                            <i class="bi bi-eye-fill"></i>
                        </a>&nbsp;
                        <a href="update_teachar.php?id=<?= $row["id"]; ?>" class="btn btn-primary btn-sm">
                            <i class="bi bi-pencil-square"></i>
                        </a>&nbsp;
                        <a href="delete_teachar.php?id=<?= $row["id"]; ?>" class="btn btn-danger btn-sm">
                            <i class="bi bi-trash"></i>
                        </a>
                    </td>
                </tr>
